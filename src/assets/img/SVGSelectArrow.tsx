...
export const SVGSelectArrow: FC<Props> = ({inSelect, active}) => <SVGSelectArrowBox inSelect={inSelect} active={active}><svg width="10" height="6" viewBox="0 0 10 6" fill="none" xmlns="http://www.w3.org/2000/svg">
...
const SVGSelectArrowBox = styled.div<Props>`
    ...
    ` : ''}
    ${({active, inSelect}) => active && !inSelect ? `
    transform:  rotate(180deg) translate(0,-5px);
    ` : ''}
`